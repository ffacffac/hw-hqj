...
import 'package:my_flutter_app/resources/widget_name_to_icon.dart';
        ...
        child: new Row(
          children: <Widget>[
            new Container(width: 30.0,
                ...
                child: new Icon(icon)) ?? null,
            new Expanded(child: new Text(value, style: Theme
                .of(context)
                .textTheme
                .subhead)),
            new Text(text, style: Theme
                .of(context)
                .textTheme
                .subhead)
          ],

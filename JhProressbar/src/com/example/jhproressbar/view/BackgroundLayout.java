package com.example.jhproressbar.view;

/*
 * Copyright 2015 Kaopiz Software Co., Ltd. Licensed under the Apache License, Version 2.0 (the
...
import com.example.jhproressbar.R;
...
class BackgroundLayout extends LinearLayout
{
	...
	color = getContext().getResources().getColor(R.color.kprogresshud_default_color);

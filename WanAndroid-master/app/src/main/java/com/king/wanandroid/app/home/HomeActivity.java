...
public class HomeActivity extends MVVMActivity<HomeViewModel, HomeActivityBinding> {
    ...
    public void initData() {
        ...
        TextView tvVersion = mHolder.getView(R.id.tvVersion);
        ...
        mBinding.rv
                .addItemDecoration(new DividerItemDecoration(getContext(), DividerItemDecoration.VERTICAL, R.drawable.line_drawable_8));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //同步收藏状态
        if (requestCode == Constants.RECODE_ARTICLE && mArticleBean != null) {
    ...
    private void clickLogout() {
        ...
        config.setTitle(getString(R.string.menu_logout)).setContent(getString(R.string.tips_logout_content))
              .setOnClickOk(v -> {
    ...
    private void clickVersion(boolean isClick) {
        ...
        mViewModel.checkVersion().observe(this, resource -> {
            if (resource == null) {
                return;
            }
            resource.handle(new Resource.OnHandleCallback<VersionBean>() {
                @Override

...
public abstract class BaseActivity extends AppCompatActivity implements HasSupportFragmentInjector {
    ...
    public void startTree(@Tree int tree, String title) {
        ARouter.getInstance().build(Constants.ROUTE_TREE).withInt(Constants.KEY_TREE, tree)
               .withString(Constants.KEY_TITLE, title).navigation(getContext());
    }
    ...
    private void startTreeChildren(@Tree int tree, String title, int id, String key) {
        ARouter.getInstance().build(Constants.ROUTE_TREE_CHILDREN).withInt(Constants.KEY_TREE, tree)
               .withString(Constants.KEY_TITLE, title).withInt(Constants.KEY_ID, id).withString(Constants.KEY_KEY, key)
    ...
    private void startWeb(String title, String author, String url, int id, boolean isCollect) {
        ARouter.getInstance().build(Constants.ROUTE_WEB).withString(Constants.KEY_URL, url)
               .withString(Constants.KEY_TITLE, title).withString(Constants.KEY_AUTHOR, author)
               .withInt(Constants.KEY_ID, id).withBoolean(Constants.KEY_IS_COLLECT, isCollect)

...
import szu.wifichat.android.activity.grounder.GroundActivity2;
import szu.wifichat.android.activity.grounder.GroundLeaderActivity2;
 ...
 */
public class WifiapActivity1 extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wifiap1);
    ...
    protected void initEvents() {
        ...
        mDialog = BaseDialog.getDialog(WifiapActivity1.this, R.string.dialog_tips, "", "确 定", this, "取 消", this);
     ...
     * 执行登陆
     **/
    private void doLogin(final boolean isPDA) {
        ...
        putAsyncTask(new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... params) {
                try {
                    ...
                    mSqlDBOperate = new SqlDBOperate(WifiapActivity1.this);// 实例化数据库操作类,新
            ...
            protected void onPostExecute(Boolean result) {
                ...
                if (result) { // 初始化Thread
                    ...
                    // if (isClient) {
                    //     startActivity(GroundLeaderActivity1.class, bundle);//领导端当成服务端
                    // } else {
                    //     startActivity(GroundActivity1.class, bundle);//地线组当成客户端
                    // }
                    if (!isPDA) {
                        startActivity(GroundLeaderActivity2.class, bundle);//领导端当成服务端
                    } else {
                        startActivity(GroundActivity2.class, bundle);//地线组当成客户端
                    }

package szu.wifichat.android.yzstts;
...
public class SpeechUtilOffline implements TTSPlayerListener {
    ...
    private static SpeechUtilOffline speechUtilOffline;
    ...
    public static SpeechUtilOffline getSpeechInstance(Context context) {
        if (speechUtilOffline == null) {
            synchronized (SpeechUtilOffline.class) {
                if (speechUtilOffline == null) {

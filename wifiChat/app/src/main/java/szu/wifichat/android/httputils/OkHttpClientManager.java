...
public class OkHttpClientManager {
     ...
     * @param url
     */
    public void getAsyn1(String url, final IGroundUpload asynCallback) {
        final Request request = new Request.Builder().url(url).build();
        //        getAsyn1(request, asynCallback);
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Request request, IOException e) {
                asynCallback.onFailure(request, e);
            }

            @Override
            public void onResponse(Response response) throws IOException {
                final String content = response.body().string();
                asynCallback.onResponse(content);

            }
        });
    }

    //    private void getAsyn1(Request request, final MyAsynCallback asynCallback) {
    //        mOkHttpClient.newCall(request).enqueue(new Callback() {
    //            @Override
    //            public void onFailure(Request request, IOException e) {
    //                asynCallback.onFailure(request, e);
    ...
    private MyAsynCallback mAsynCallback;

    public interface MyAsynCallback {
    ...
    //                    int inSampleSize = ImageUtils.calculateInSampleSize(actualImageSize,
    // imageViewSize);
    //                    try
    //                    {
    //                        is.reset();
    ...
    public static void postAsyn(String url, ResultCallback callback, File[] files, String[] fileKeys,
                                Param... params) throws IOException {
    ...
    //    public static void displayImage(final ImageView view, String url, int errorResId) throws
    //            IOException {
    ...
    // public void cancelRequest(Object cls) {
    //     mOkHttpClient.cancel(cls);
    // }
}

...
public class TcpClient implements Runnable {
    ...
    // 重写方法
    public void sendFile(String filePath, String target_IP, GroundMessage.CONTENT_TYPE type) {
    ...
    public class SendFileThread extends Thread {
        ...
        private GroundMessage.CONTENT_TYPE type;
        ...
        public SendFileThread(String target_IP, String filePath, GroundMessage.CONTENT_TYPE type) {

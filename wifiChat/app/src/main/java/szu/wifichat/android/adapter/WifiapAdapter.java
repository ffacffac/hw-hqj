...
public class WifiapAdapter extends BaseAdapter {
    ...
    private boolean isConnected;//是否已经连接成功，连接成功的话就停止掉连接的动画
     ...
     * @param list
     */
    public void refreshAdapter(List<String> list, boolean isConnectResult) {
        this.mList = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.textConnect = ((TextView) convertView.findViewById(R.id
                    .connect_text_wtitem));

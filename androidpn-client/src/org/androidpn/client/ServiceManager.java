...
public final class ServiceManager {
	...
	public ServiceManager(Context context) {
		...
		props = loadProperties();// 加载res/raw/androidpn.properties文件的内容
		apiKey = props.getProperty("apiKey", Config.apiKey);
		xmppHost = props.getProperty("xmppHost", Config.serverIp);
		xmppPort = props.getProperty("xmppPort", Config.port);
		Log.i(LOGTAG, "apiKey=" + apiKey);
